...
/**
 * 设置 SX1276 LORA 收发器模式
 * @param   opMode[收发器模式标志]
 * @return 
 * @brief 
 **/
...
uint32_t SX1276LoRaProcess( void )
{
    ...
    case RFLR_STATE_RX_INIT:
				SX1276LoRaSetOpMode( RFLR_OPMODE_STANDBY );	//切换到待机模式
        ...
        RFLRState = RFLR_STATE_RX_RUNNING;	//切换到接收运行状态
        break;
